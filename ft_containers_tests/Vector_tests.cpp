...
void vector_tests(void)
{
    ...
    std::cout << "\033[1;37m[-------------------- [" << std::setw(40) << std::left << " copy constructor " //! abort
              << "] --------------------]\t\t\033[0m";
    {
        /*---------------------------------- time limit test --------------------------------------------*/
        {
              ...
              << "] --------------------]\t\t\033[0m";
    {
        /*-------------------------------------- time limit test -----------------------------------*/
        {
            ...
            // std::cout << ">>>" << *ft_v1.erase(ft_v1.begin() + 1e5) << std::endl;
            ualarm(0, 0);
        }
        /*
         * strings to store the resutls
        ...
        // std::cout << ">>>" << *ft_v.erase(ft_v.begin() + 100) << std::endl;
