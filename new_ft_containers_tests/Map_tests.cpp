...
typedef ft::pair<ft::map<int, std::string>::biterator, ft::map<int, std::string>::biterator> ft_iter_def;
typedef std::pair<std::map<int, std::string>::const_iterator, std::map<int, std::string>::const_iterator> const_iter_def;
typedef ft::pair<ft::map<int, std::string>::const_biterator, ft::map<int, std::string>::const_biterator> ft_const_iter_def;
...
void iterator_tests(void)
{
    ...
    ft::map<int, char>::biterator my_it, my_it1, tmp;
    ...
    std::cout << "\t\033[1;37m[-------------------- [" << std::setw(40) << std::left << " copy constructor "
              << "] --------------------]\t\t\033[0m";
    {
        ft::map<int, char>::biterator ob(my_it);
        EQUAL(&(*my_it) == &(*ob));
    }
    std::cout << "\t\033[1;37m[-------------------- [" << std::setw(40) << std::left << " iterator to const_iterator "
              << "] --------------------]\t\t\033[0m";
    {
        ft::map<int, char>::const_biterator c_it, c_ob(my_it);
        c_it = my_it;
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::map<int, std::string>::biterator my_it = my_m.begin();
              ...
              << "] --------------------]\t\t\033[0m";
    {
        /*---------------------------------- time limit test --------------------------------------------*/
        {
            ...
            ualarm(diff * 1e3, 0);
            for (ft::map<int, std::string>::biterator it = ft_m.begin(); it != ft_m.end(); ++it)
                ;
            ualarm(0, 0);
        }
        bool cond(false);
        {
            ...
            for (ft::map<int, int>::biterator it = m.begin(); it != m.end(); ++it)
                res += it->first;
            cond = res == 210;
        }
        {
...
void const_iterator_tests(void)
{
    ...
    ft::map<int, char> my_m;
    ft::map<int, char>::const_biterator my_it, my_it1, tmp;
    ...
    std::cout << "\t\033[1;37m[-------------------- [" << std::setw(40) << std::left << " copy constructor "
              << "] --------------------]\t\t\033[0m";
    {
        ft::map<int, char>::const_biterator ob(my_it);
        EQUAL(*my_it == *ob);
    }
    std::cout << "\t\033[1;37m[-------------------- [" << std::setw(40) << std::left << " == operator "
              << "] --------------------]\t\t\033[0m";
...
void testConstructors()
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        for (std::map<int, std::string>::iterator it = m.begin(); it != m.end(); ++it) // fill res from std::map
            res += it->second;
        for (ft::map<int, std::string>::biterator it = my_m.begin(); it != my_m.end(); ++it) // fill res from std::map
            my_res += it->second;
        EQUAL(res == my_res);
    }
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        for (ft::map<int, std::string>::biterator it = my_m.begin(); it != my_m.end(); ++it)
        { // fill my_res from ft::map
            my_res += it->second;
            my_sum += it->first;
        }

        for (ft::map<int, std::string>::biterator it = my_m1.begin(); it != my_m1.end(); ++it)
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        std::string res, res1;
        /*--------------------------------------------------------*/
        for (ft::map<int, char>::biterator it = m1.begin(); it != m1.end(); ++it) // fill res from m1
            res += it->second;

        for (ft::map<int, char>::biterator it = copy_m.begin(); it != copy_m.end(); ++it) // fill res from copy_m
            res1 += it->second;
        EQUAL(res == res1);
    }
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        for (ft::map<int, std::string>::biterator it = ft_m1.begin(); it != ft_m1.end(); ++it) // fill ft_res from ft_m1
            ft_res += it->first;
...
void testIterators()
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        for (ft::map<int, std::string>::biterator it = ft_m1.begin(); it != ft_m1.end(); ++it) // fill ft_res from ft_m1
            ft_res += it->second;
        for (ft::map<int, std::string>::const_biterator rit = ft_m2.begin(); rit != ft_m2.end(); ++rit) // fill c_ft_res from const ft_m1
            c_ft_res += rit->second;
        ...
        ft::map<int, int>::biterator eit = end_test.end();
        eit--;
...
void testCapacityMethods()
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        // std::cout << m4.size() << " - " << ft_m4.size() << std::endl;
        // std::cout << m5.size() << " - " << ft_m5.size() << std::endl;
...
void testModifiers()
{
    ...
    //     ft::pair<ft::map<char, int>::biterator, bool> ft_ret;
    ...
    //     ft::map<char, int>::biterator ft_it = ft_m.begin();
    ...
    //     ft::map<char, int>::biterator ft_it;
...

    {
        ...
        std::cout << "\n++++++++++++++++++++++++++++++\n";
        std::map<std::string, std::string, std::greater<std::string> >::iterator it = m1.begin(), ite = m1.end();
        std::map<std::string, std::string, std::greater<std::string> >::iterator itf = m2.begin(), itfe = m2.end();
        ...
        std::cout << "\n++++++++++++++++++++++++++++++\n";
        ft::map<std::string, std::string, std::greater<std::string> >::biterator bit = ft_m1.begin(), bte = ft_m1.end();
        ft::map<std::string, std::string, std::greater<std::string> >::biterator btf = ft_m2.begin(), btfe = ft_m2.end();
        ...
        const ft::map<std::string, std::string, std::greater<std::string> >::biterator ft_iter = std::next(ft_m1.begin());

        // std::cout << "──────── before swap ────────\n"
        //           << "m1: " << m1 << "m2: " << m2 << "ref: " << ref
        //           << "\niter: " << *iter << '\n';

        std::cout << m1.begin()->first << " - " << ft_ref.first << std::endl;
...
void testObservers()
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::map<int, int>::biterator ft_it = ft_m.begin();
        do
        {
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::map<char, int>::biterator it = mymap.begin();
        do
        {
            sum += it->second;
            s_key += it->first;
...
void testNonMemberSwap()
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        for (ft::map<char, int>::biterator it = foo.begin(); it != foo.end(); ++it)
        {
            res += it->second;
            key_res += it->first;
        }

        for (ft::map<char, int>::biterator it = bar.begin(); it != bar.end(); ++it)
        {
            ft_res += it->second;
            ft_key_res += it->first;
        }
...
void testOperations()
{
    ...
    //     ft::map<int, std::string>::biterator ft_it;
    ...
    //     ft::map<char, int>::biterator ft_it2;
